  ...
  return (
    <div className="flex flex-row w-screen h-full p-3">
      <div className="w-1/5 h-full gap-10 flex flex-col justify-center items-center">
        <CardItem
          className="h-1/5 w-full flex relative flex-col items-center justify-center gap-10"
        ...
        <CardItem
          className="h-1/5 w-full flex relative flex-col items-center justify-center gap-10"
          title="Total Successfull Requests"
          content="104"
          description="Last 24 hours"
          warning={false}
        />
      ...
      <div className="w-4/5">
        ...
        <div className="h-1/2 w-full flex flex-row gap-25 items-center justify-center">
          <Pychart
            ...
            isLoading={dataRequestTraffic.isLoading}
            lable="successful requests"
            title="Successful Requests"
            analytics={dataRequestTraffic.data}
          />
          <Pychart
            className="w-fit h-fit flex flex-col justify-center items-center"
            isLoading={dataBlockedTraffic.isLoading}
            lable="blocked requests"
            title="Blocked Requests"
            analytics={dataBlockedTraffic.data}
          />
          <Pychart
            className="w-fit h-fit flex flex-col justify-center items-center"
            isLoading={dataTraffic.isLoading}
            lable="Traffic"
            title="Traffic"
            analytics={dataTraffic.data}
          />
        </div>
      </div>
    </div>
